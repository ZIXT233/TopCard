...
export function ModelsConfig({ onClose, embedded = false }: { onClose: () => void; embedded?: boolean }) {
  ...
  return (
    <>
    <ConfigPanelShell embedded={embedded} title={t("models.piTitle")} subtitle="~/.pi/agent/models.json" closeLabel={t("i18n.close")} onClose={onClose}>

        <p className="pi-models-scope">{t("models.piScope")}</p>
        {/* Body */}
        <ConfigSplitView>
