...
export const zhCNLocale: LocalePlugin = {
  ...
  "settings.completionNotificationsDescription": "应用在后台时，AI 回复就绪后发送系统通知。",
    "settings.notificationSystemSettingsOpened": "系统已关闭 TopCard 通知，已打开通知设置，请允许 TopCard。",
    "settings.notificationChecking": "正在检查系统通知权限…",
    "settings.notificationEnabled": "系统通知已开启，测试通知已发送。",
    "settings.notificationSystemSettingsFailed": "系统通知没有开启，请在系统设置中允许 TopCard 通知。",
  ...
  "settings.general": "常规",
    ...
    "settings.claudeCodeDescription": "填入普通 Anthropic API Key 即可，中转站兼容接口也可以。保存后需要重启已有的 Claude 卡片。",
    "settings.claudeApiKey": "Anthropic API Key",
    "settings.claudeApiKeyPlaceholder": "sk-ant-… 或中转站 Key",
    "settings.claudeApiKeyConfigured": "已保存 API Key。留空表示继续使用现有 Key，输入新 Key 则替换。",
    "settings.claudeApiKeyMissing": "尚未保存 API Key。Claude Code 会继续使用登录态或当前 Shell 环境。",
    "settings.claudeBaseUrl": "API 地址",
    "settings.claudeBaseUrlPlaceholder": "https://api.anthropic.com，或中转站地址",
    "settings.claudeAuthSave": "保存 Claude 设置",
    "settings.claudeAuthClear": "清除 Key",
    "settings.claudeAuthSaved": "Claude API 设置已保存。",
    "settings.claudeAuthCleared": "已清除 Claude API 设置。",
