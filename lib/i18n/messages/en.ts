...
export const enLocale: LocalePlugin = {
  ...
  "settings.general": "General",
    ...
    "settings.claudeCodeDescription": "Use a standard Anthropic API key, including keys from a compatible relay. Existing Claude cards must be restarted after you save.",
    "settings.claudeApiKey": "Anthropic API key",
    "settings.claudeApiKeyPlaceholder": "sk-ant-… or your relay key",
    "settings.claudeApiKeyConfigured": "API key is stored. Leave blank to keep it, or enter a new key to replace it.",
    "settings.claudeApiKeyMissing": "No API key stored. Claude Code will keep using login or your shell environment.",
    "settings.claudeBaseUrl": "API base URL",
    "settings.claudeBaseUrlPlaceholder": "https://api.anthropic.com — or your relay URL",
    "settings.claudeAuthSave": "Save Claude settings",
    "settings.claudeAuthClear": "Remove key",
    "settings.claudeAuthSaved": "Claude API settings saved.",
    "settings.claudeAuthCleared": "Claude API settings removed.",
