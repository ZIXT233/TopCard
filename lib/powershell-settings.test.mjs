...
test("PowerShell defaults on Windows, respects explicit Bash, and is never selected elsewhere", () => {
  assert.equal(isPowerShellToolEnabled(undefined, "win32"), true);
  assert.equal(isPowerShellToolEnabled(["read", "bash"], "win32"), false);
  assert.equal(isPowerShellToolEnabled([], "win32"), false);
