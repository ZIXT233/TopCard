...
export const codexAdapter: HarnessAdapter = {
  id: "codex",
  executable: "codex",
  args: ["-c", 'tui.terminal_title=["app-name","status","spinner","session-id"]'],
  ...
  createProbe() {
    ...
    return { get sessionId() { return sessionId; }, get sessionIdPrefix() { return sessionIdPrefix; }, push(data) {
      pending += data;
      ...
      for (;;) {
        ...
        if (/Action Required/.test(title)) state = "attention";
